...
#define STRING_CONFIG_H_AUTHOR "(xro@r3, Rambo1.3)" // Who made the changes.
...
// Values from running AutoTune on 2017-09-15 at r3
#define  DEFAULT_bedKp 166.0
#define  DEFAULT_bedKi 16.65
#define  DEFAULT_bedKd 390.0
...
#define EXTRUDE_MAXLENGTH (298+275) //prevent extrusion of very large distances.
...
#define DEFAULT_MAX_FEEDRATE          {800, 800, 6, 50}      // (mm/sec)
...
#define DEFAULT_XJERK                8.0    // (mm/sec)
#define DEFAULT_YJERK                8.0    // (mm/sec)
